...
public class BusController {
	...
	@PutMapping("/buses")
	public ResponseEntity<Bus> updateBus(@RequestBody Bus bus,@RequestParam("busId") Integer busId,@RequestParam("authKey")String key){
		
		Bus b=busService.updateBus(bus, busId, key);
		return new ResponseEntity<Bus>(b,HttpStatus.CREATED);
	}
}
